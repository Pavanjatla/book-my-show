    ...
    return (<>
        ...
        <div>
            ...
            <div className="lg:hidden w-full" >
                <img src={movie.backdrop_path} alt="cover"  className="m-4 rounded" style={{width:"calc(100% - 2rem"}} />
            </div>
            ...
            <div className=" relative hidden w-full lg:block" style={{height:"30rem"}}>
                ...
                <div className="absolute z-30 left-24 top-10 flex items-center gap-10">
                    <div className="w-64  h-96">
                        <img src={movie.poster_path} alt="poster" className=" w-full h-full rounded-xl" />
                ...
                <img src={movie.backdrop_path} alt="poster" className="w-full h-full" />
